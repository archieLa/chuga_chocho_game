...
| | State |
|---|---|
| Locations | **46 done, across 42 states + DC** — Bentonville (AR) is the newest, and the first scene with a SECOND signalled crossing: its bike signal goes green when the railway gate is down. |
