...
| Asset | Where | State |
|---|---|---|
| 20 location scenes | `play/assets/scenes/*.svg` | **Final.** 1280×720, horizon y=300, track band y=450–516, both gates at fixed coords. |
...
| Location data | `play/js/world.js` | 20 locations, each with `scene`, `say` (en/pl) and `trainPreset`. |
