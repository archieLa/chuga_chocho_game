...
🎨 **The art keeps growing** — **27 locations**, 18 locomotives and wagons, and the offline
US map are committed. Wave 1 of the scene roadmap is complete; see `SCENE_ROADMAP.md`.

✅ **Phase 1 — Free Play is playable.** The game opens on the US map, all twenty-seven destinations
